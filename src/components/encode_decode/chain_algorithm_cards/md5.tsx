...
export interface Md5Props {
    title: string,
    id: string,
    algorithm_key: any,
}
export default function Md5(props: Md5Props) {
    ...
    return (
        <Paper elevation={2} sx={{}}>
            ...
            <TextField type="text" label="Salt" sx={{ marginBottom: 1 }} required onChange={handleChange} value={key} />
        </Paper>
    )
}
