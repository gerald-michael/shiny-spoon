...
export interface BaconProps {
    title: string,
    id: string,
    algorithm_key: any,
}
export default function Bacon(props: BaconProps) {
    ...
    return (
        <Paper elevation={2} sx={{}}>
            ...
            <TextField type="text" label="Key" sx={{ marginBottom: 1 }} required onChange={handleChange} value={key} placeholder="eg. += 10 ab" />
        </Paper>
    )
}
